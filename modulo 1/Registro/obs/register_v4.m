...
[PET,info_PET,Rescale_PET]=f_cargo_imagen(tipo);% 1 es tiff
PET=squeeze(PET);
PET=double(PET);
...
PET2=PET2.*n; 
%% 
%PET2=f_Rescale_Bq(PET2,info_PET,Rescale_PET); %para pasar a Bq  
%close all 
%%
figure(nfig)
set(gcf,'Render','OpenGL')
...
file=[directorio_mat,'/paciente.mat'];
delete(file)
save(file,'paciente')

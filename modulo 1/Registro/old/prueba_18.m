...
% y=sPET(2)-y; 
 ...
 d1=pos2(:,2)-R_PET.YWorldLimits(1); 
 d2=R_PET.YWorldLimits(2)-pos2(:,2); 
 
 d3=d1+d2; 
 d4=R_PET.YWorldLimits(2)-R_PET.YWorldLimits(1); 
 
 %%
 %MCNP esta flipeado y 
 pos31(:,2)=R_PET.YWorldLimits(2)-d1; 
 pos32(:,2)=d2+R_PET.YWorldLimits(1); 

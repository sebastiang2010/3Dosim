...
_MAIN_PIPELINE = os.path.join(
    _PROJECT_ROOT, "3DSlicerModule", "SlicerDosim",
    "Testing", "PipelineOrchestrator", "main.py"
)
_RUN_DOSIMETRY = os.path.join(
    _PROJECT_ROOT, "3DSlicerModule", "SlicerDosim",
    "Testing", "PipelineOrchestrator", "run_dosimetry_from_scene.py"
)
_CONFIG_PATH = os.path.join(
    _PROJECT_ROOT, "3DSlicerModule", "SlicerDosim",
    "Modules", "Scripted", "SlicerDosim",
    "Resources", "Config", "config.jsonc"
)
# ── Colores ──
MOD1_COLOR = "#2196F3"
MOD2_COLOR = "#FF9800"
...
class LauncherWindow(QMainWindow):
    ...
    def _build_ui(self):
        self.setWindowTitle("3Dosim Launcher v3.14")
        ...
        self._sbar.insertPermanentWidget(0, QLabel("v3.14 · PyQt5 · 3D Slicer"))

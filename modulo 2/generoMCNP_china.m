...
n_tumor=5; %numero de tallies de verificacion 
...
f_genero_geometria_1(cell,mat,archivo,image_size,IdMat,flip); 
% pregunto del tamano del voxel 
%tvoxel=f_tvoxel(tvoxel);
%% genero el voxelizado  
tic 
%f_genero_voxel_1(I1,archivo); 
f_genero_voxel_2(I1,archivo)
%f_genero_voxel_3(I1,archivo)
time.voxel=toc;

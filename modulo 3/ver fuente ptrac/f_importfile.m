function a = f_importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   POS3P = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   POS3P = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   pos3p = importfile('pos_3_p', 12, 30009);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/03/17 11:10:21
...
formatSpec = '%f%f%f%f%f%f%f%f%f%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%[^\n\r]';
